...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Balsamiq+Sans:wght@700&family=Pacifico&display=swap"
    ...
    <link rel="stylesheet" href="./css/social-csi.css">
  <!-- Bootstrap core CSS -->
    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="./images/g15.jpg" class="d-block w-100" alt="...">
    ...
    <ul>
      <li class="card" tabindex="0" aria-haspopup="true">
        <div class="intro card1">
          ...
          <h3 class="event">Very Cool Event</h3>
        </div>
        <div class="info back1">
          <p class="eventTitle"><h3>Event Name</h3></p>
          <center><div class="block2"></div></center>
          <h5>Description</h5>
          <p class="eventDescription"><h6>This will be description. This has to be 3-4 lines so I am typing for no apparent reason. Ye lo ek aur line for no reason at all. And ek aur.</h6></p>
  
          <h5>Date & Time</h5>
          <p class="eventDate"><h6 class="date">17th August 2020</h6></p>
          <p class="eventTime"><h6 class="date">11:00 AM</h6></p>
          <br/>
